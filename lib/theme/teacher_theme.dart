...
class TeacherThemeColors extends ThemeExtension<TeacherThemeColors> {
  // Layout colors
  ...
  factory TeacherThemeColors.dark() => TeacherThemeColors(
  ...
  factory TeacherThemeColors.light() => TeacherThemeColors(
  ...
  @override
  ThemeExtension<TeacherThemeColors> lerp(
    ThemeExtension<TeacherThemeColors>? other,
    double t,
  ) {
    if (other is! TeacherThemeColors) return this;
    return TeacherThemeColors(
